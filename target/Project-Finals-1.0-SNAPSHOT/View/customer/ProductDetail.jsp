<%-- 
    ...
    Created on : Nov 29, 2024, 10:38:48 PM
    Author     : ASUS
--%>
...
<html lang="en" data-bs-theme="light" data-pwa="true">
    ...
    <head>
        ...
        <link rel="stylesheet" href="View/customer/css/modal.css" />
  ...
  <body>
          ...
          >
            ...
            <div class="d-flex align-items-center">
              ...
              <a
                ...
                href="/Project-Finals/account-info"
              >
    ...
    <main class="content-wrapper">
      ...
      <!-- Page title -->
      <h1 class="h3 container mb-4">${dt.getTen()}</h1>

      <!-- Nav links -->
      <section
        class="container position-relative z-2 pb-4 pb-md-5 mb-2 mb-md-0"
      >
        <div class="border-bottom">
          <ul class="nav nav-underline flex-nowrap gap-4">
            <li class="nav-item me-sm-2">
              <a class="nav-link pe-none active" href="#!">Chi tiết sản phẩm</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="shop-product-reviews-electronics.html"
                >Đánh giá (68)</a
              >
            </li>
          </ul>
      ...
      <section class="container pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
        <div class="row">
          ...
          <aside
            class="col-md-5 col-xl-4 offset-xl-1 order-md-2 mb-5 mb-md-0"
            id="scrollPastPoint"
            style="margin-top: -100px"
          >
            <div
              class="position-sticky top-0 ps-md-3 ps-lg-4 ps-xl-0"
              ...
              <div class="border rounded p-3 p-lg-4">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="w-100 min-w-0 ps-2 ps-sm-3">
                        ...
                        <h4 class="fs-sm fw-medium mb-2">
                         ${dt.getTen()}
                        </h4>
                        <div class="h5 mb-0">${dt.getGia()}</div>
                      </div>
                    </div>
          ...
          <div class="col-md-7 order-md-1">
            ...
            <ul
              class="list-unstyled d-flex flex-column gap-3 fs-sm pb-3 m-0 mb-2 mb-sm-3"
            >
              ...
              <li class="d-flex align-items-center position-relative pe-4">
                ...
                <i
                  ...
                  data-bs-content="Ceramic shield front, Glass back and Aluminium design"
                ></i>
              </li>
              <li class="d-flex align-items-center position-relative pe-4">
                ...
                <span
                  class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                ></span>
                <span class="text-dark-emphasis fw-medium text-end">${dt.getRom()}GB</span>
              </li>
              <li class="d-flex align-items-center position-relative pe-4">
                <span>Cpu </span>
                <span
                  class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                ></span>
                <span class="text-dark-emphasis fw-medium text-end">${dt.getCpu()}</span>
              </li>
              <li class="d-flex align-items-center position-relative pe-4">
                <span>Ram</span>
                <span
            ...
            >
                <li class="d-flex align-items-center position-relative pe-4">
                  ...
                  <span
                    class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                  ></span>
                  <span class="text-dark-emphasis fw-medium text-end">${dt.getManHinh()}"</span>
                </li>
                <li class="d-flex align-items-center position-relative pe-4">
                    <span>Màu sắc:</span>
                    <span
                      class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                    ></span>
                    <span class="text-dark-emphasis fw-medium text-end">${dt.getMauSac()}"</span>
                </li>
                <li class="d-flex align-items-center position-relative pe-4">
                    <span>Loa</span>
                    <span
                      class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                    ></span>
                    <span class="text-dark-emphasis fw-medium text-end">${dt.getLoa()}"</span>
                </li> 
            </ul>
            <h3 class="h6">Nguồn và pin</h3>
            <ul
              class="list-unstyled d-flex flex-column gap-3 fs-sm pb-3 m-0 mb-2 mb-sm-3"
            >
              <li class="d-flex align-items-center position-relative pe-4">
                ...
                <span
                  class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                ></span>
                <span class="text-dark-emphasis fw-medium text-end">${dt.getPin()} mAh</span>
              </li>
            </ul>
            <h3 class="h6">Kích thước và khối lượng</h3>
            <ul
              class="list-unstyled d-flex flex-column gap-3 fs-sm pb-3 m-0 mb-2 mb-sm-3"
            >
              <li class="d-flex align-items-center position-relative pe-4">
              ...
              <li class="d-flex align-items-center position-relative pe-4">
                ...
                ></span>
                <span class="text-dark-emphasis fw-medium text-end"
                  >${dt.getKhoiLuong()}</span
                >
              </li>
            </ul>
            <div class="alert d-flex alert-info mb-2 mb-sm-3" role="alert">
              <i
                class="ci-info fs-lg pe-1 me-2"
                style="margin-top: 0.125rem"
              ></i>
              <div class="fs-sm">
                Thông số kỹ thuật và thiết bị của sản phẩm có thể thay đổi mà không cần báo trước.
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="confirmAddToCartModal" tabindex="-1" aria-labelledby="confirmAddToCartModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="confirmAddToCartModalLabel">Xác nhận thêm vào giỏ hàng</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p>Bạn có chắc chắn muốn thêm sản phẩm này vào giỏ hàng không?</p>
            </div>
            <div class="modal-footer">
              <!-- Form to submit data -->
              <form action="" method="post">
                <!-- Hidden input to pass product ID (if needed) -->
                <input type="hidden" name="productId" value="addItem" id="productIdInput">
