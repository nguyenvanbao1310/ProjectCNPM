            ...
            <div class="d-lg-flex">
                <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
                    ...
                    <div class="nav fs-sm mb-4">
                        ...
                        <a class="nav-link text-decoration-underline p-0 ms-2" href="/Project-Finals/register">Create an account</a>
                    </div>
                    ...
                    <!--Form đăng nhập-->
                    <form action="/Project-Finals/login" method="POST">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="nav">
                                <a class="nav-link animate-underline p-0" href="/Project-Finals/forgot-password">
