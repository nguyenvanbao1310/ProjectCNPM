...
<!DOCTYPE html><html lang="en" data-bs-theme="light" data-pwa="true">
    <!-- Mirrored from cartzilla.createx.studio/account-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 06:29:55 GMT -->
    ...
    <head>
        ...
        <!-- SEO Meta Tags -->
        <title>Cartzilla | Account - My Reviews</title>
    ...
    <body>
        ...
        <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shoppingCart" tabindex="-1" aria-labelledby="shoppingCartLabel" style="width: 500px">
            ...
            <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
                ...
                <div class="d-flex align-items-center">
                    <a class="flex-shrink-0" href="shop-product-general-electronics.html">
                        <img src="View/customer/View/customer/assets/img/shop/electronics/thumbs/01.png" width="110" alt="Smart Watch">
                    </a>
                    <div class="w-100 min-w-0 ps-2 ps-sm-3">
                        <h5 class="d-flex animate-underline mb-2">
        ...
        <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="reviewDetails" tabindex="-1" aria-labelledby="reviewDetailsLabel" style="width: 500px">
            ...
            <div class="offcanvas-body pt-2">
                ...
                <div class="d-flex align-items-center border-bottom mb-4">
                    <a class="flex-shrink-0" href="shop-product-general-electronics.html">
                        <img id="rvImg" src="View/customer/assets/img/shop/electronics/thumbs/07.png" width="110" alt="MacBook">
                    </a>
                    <div class="w-100 min-w-0 ps-2 ps-sm-3">
                        <h5 class="d-flex animate-underline mb-2">
                            <a id="rvName" class="d-block fs-sm fw-medium text-truncate animate-target" href="shop-product-general-electronics.html">Laptop Apple MacBook Pro 13 M2</a>
                        </h5>
                        <div id="rvPrice" class="h6 mb-0">$1,200.00</div>
                    </div>
                </div>

                <!-- Review -->
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div id="rvSao" class="d-flex gap-1 fs-sm me-2 me-sm-3">
                    ...
                    <div class="fs-sm text-body-secondary" id="rvDate">June 17, 2024</div>
                </div>
                <div class="d-flex gap-2 pb-2 mb-1">
                    <div class="d-flex fs-sm me-4">
                        <span class="text-dark-emphasis fw-medium me-2" >Color:</span>
                        <span id="rvColor">Space Gray</span>
                        
                    </div>
                    <div class="d-flex fs-sm">
                        <span class="text-dark-emphasis fw-medium me-2">Model:</span>
                        <span id="rvRom">256GB</span>
                    </div>
                </div>
                <p id="rvContent" class="fs-sm">After 6 months of using the laptop, I can say that it fully meets the needs. The main advantage is smooth operation without hangs, the function of scanning fingerprints to unlock the laptop works perfectly, it will be useful for those who work in the office (confidentiality of information is guaranteed).</p>
        ...
        <!-- Review form modal -->
        <div class="modal" id="reviewForm" data-bs-backdrop="static" tabindex="-1" aria-labelledby="reviewFormLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <form action="/account-review" method="POST" class="modal-content needs-validation" novalidate="">
                    <div class="modal-header d-block pb-3">
                        <div class="col-md-12">
                            <input type="text" id="idForm" name="productId" hidden class="form-control">
                        </div>
                        <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="flex-shrink-0" href="shop-product-general-electronics.html">
                                <img id="imgForm" src="View/customer/assets/img/shop/electronics/thumbs/10.png" width="110" alt="MacBook">
                            </a>
                            <div class="w-100 min-w-0 ps-2 ps-sm-3">
                                <h5 class="d-flex animate-underline mb-2">
                                    <a id="nameForm" class="d-block fs-sm fw-medium text-truncate animate-target" href="shop-product-general-electronics.html">Apple iPhone 14 Plus 128GB Blue</a>
                                </h5>
                                <div id="priceForm" class="h6 mb-0">$940.00</div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-body pb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="review-name" value="${khachHang.ten}" readonly="">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" class="form-control" rows="4" id="review-text" required=""></textarea>
                                            ...
                                            <ul
                                                ...
                                                <li class="d-lg-none pt-2">
                                                    <a
                                                        ...
                                                        All Categories
                                                        <i
                                                            class="ci-chevron-right fs-base ms-auto me-n1"
                                                            ></i>
                                                    </a>
                                                </li>
                                                <li class="dropend position-static">
                                                    <div
                                                        ...
                                                        <a
                                                            ...
                                                            >
                                                            <i
                                                                class="ci-smartphone-2 fs-xl opacity-60 pe-1 me-2"
                                                                ></i>
                                                    ...
                                                    <div
                                                        ...
                                                        >
                                                        <div
                                                            class="d-flex flex-column flex-lg-row h-100 gap-4"
                                                            >
                                                            <div style="min-width: 194px">
                                                                <div class="d-flex w-100">
                                                                    <a
                                                                        class="animate-underline animate-target d-inline h6 text-dark-emphasis text-decoration-none text-truncate"
                                                                        href="shop-catalog-electronics.html"
                                                                        >Smartphones</a
                                                                    >
                                                                </div>
                                                            ...
                                                            <div class="d-none d-lg-block">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-center px-2">
                                                                        <i
                                                                            class="ci-apple fs-1 text-dark-emphasis mb-2"
                                                                            ></i>
                                                                    ...
                                                                    <img
                                                                        src="View/customer/assets/img/mega-menu/electronics/02.png"
                                                                        width="252"
                                                                        alt="iPad Pro"
                                                                        />
                            ...
                            <c:forEach var="item" items="${productList}">
                                <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                                    <div class="nav flex-nowrap position-relative align-items-center">
                                        <img src="${item.dienThoai.hinhAnh}" class="d-block my-xl-1" width="64" alt="Image">
                                        <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="#">
                                            ${item.dienThoai.ten}</a>
                                    </div>
                                    <c:if test="${item.danhGia == null}">
                                        <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                            ...
                                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" 
                                                    ...
                                                    onclick="clickModal('${item.dienThoai.hinhAnh}', '${item.dienThoai.ten}', ${item.dienThoai.gia}, '${item.dienThoai.id}')"      
                                    ...
                                    <c:if test="${item.danhGia != null}">
                                        <div class="position-relative d-flex align-items-center text-decoration-none min-w-0 pt-1 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                            ...
                                            <div class="d-flex gap-1 fs-sm me-2 me-sm-3">
                                                <c:forEach  begin="1" end="${item.danhGia.soSao}">
                                                    <i class="ci-star-filled text-warning"></i>
                                                </c:forEach>
                                                <c:forEach  begin="${item.danhGia.soSao + 1}" end="5">
                                                    <i class="ci-star text-body-tertiary opacity-75"></i>
                                                </c:forEach>

                                            </div>
                                            <a onclick="reviewDetail('${item.dienThoai.hinhAnh}', '${item.dienThoai.ten}', 
                                               ${item.dienThoai.gia}, ${item.danhGia.soSao}, 
                                                           '${item.danhGia.noiDung}', '${item.dienThoai.mauSac}', '${item.dienThoai.rom}', '${item.danhGia.reviewDate}')" class="btn btn-icon btn-ghost btn-secondary stretched-link border-0" href="#reviewDetails" data-bs-toggle="offcanvas" aria-controls="reviewDetails" aria-label="Show review details">
    ...
    <script>
                                                        function clickModal(hinhAnh, ten, gia, id) {
                                                            console.log(hinhAnh);
                                                            console.log(ten);
                                                            console.log(gia);
                                                            console.log(id);
                                                            ...
                                                            document.getElementById('imgForm').src = hinhAnh;
                                                            document.getElementById('nameForm').textContent = ten;
                                                            document.getElementById('priceForm').textContent = `$` + gia;
                                                        }
        function reviewDetail(hinhAnh, ten, gia, soSao, noiDung, mauSac, rom, date){
            console.log(hinhAnh);
            console.log(ten);
            console.log(gia);
            console.log(soSao);
            ...
            document.getElementById('rvImg').src = hinhAnh;
            document.getElementById('rvName').textContent = ten;
            document.getElementById('rvPrice').textContent = `$` + gia;
            document.getElementById('rvContent').textContent = noiDung;
            
            var html = ``;
            
            for(var i = 1; i <= soSao; i++ ){
                html += `<i class="ci-star-filled text-warning"></i>`
            }
            for(var i = soSao; i < 5;i++){
                html += `<i class="ci-star text-body-tertiary opacity-75"></i>`
            }
            
            document.getElementById("rvSao").innerHTML = html;
            
            document.getElementById('rvColor').textContent = mauSac;
            document.getElementById('rvRom').textContent = rom + 'GB';
