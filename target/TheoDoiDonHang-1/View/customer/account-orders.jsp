...
<!DOCTYPE html><html lang="en" data-bs-theme="light" data-pwa="true">
                        ...
                        <div class="ps-lg-3 ps-xl-0">
                            ...
                            <div class="row align-items-center pb-3 pb-md-4 mb-md-1 mb-lg-2">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <div class="row row-cols-1 row-cols-sm-2 g-3 g-xxl-4">
                                        <div class="col">
                                            <form id="filterForm" method="post" action="/Project-Finals/account-order">
                                                <select class="form-select" name="status" onchange="document.getElementById('filterForm').submit()" data-select="{
                                                        ...
                                                        &quot;label&quot;: &quot;<div class=\&quot;d-flex align-items-center\&quot;><span class=\&quot;bg-info rounded-circle p-1 me-2\&quot;></span>Đang giao hàng</div>&quot;
                                                        },
                                                        {
                                                        &quot;value&quot;: &quot;Hoàn thành&quot;,
                                                        &quot;label&quot;: &quot;<div class=\&quot;d-flex align-items-center\&quot;><span class=\&quot;bg-success rounded-circle p-1 me-2\&quot;></span>Hoàn thành</div>&quot;
                                                        },
                                                        {
                                                        &quot;value&quot;: &quot;Đã hủy&quot;,
                                                        &quot;label&quot;: &quot;<div class=\&quot;d-flex align-items-center\&quot;><span class=\&quot;bg-danger rounded-circle p-1 me-2\&quot;></span>Đã hủy</div>&quot;
                                                        },
                                                        {
                                                        &quot;value&quot;: &quot;Chưa giải quyết&quot;,
                                                        &quot;label&quot;: &quot;<div class=\&quot;d-flex align-items-center\&quot;><span class=\&quot;bg-warning rounded-circle p-1 me-2\&quot;></span>Chưa giải quyết</div>&quot;
                                                        }
                                                        ]
                            ...
                            <div data-filter-list="{&quot;listClass&quot;: &quot;orders-list&quot;, &quot;sortClass&quot;: &quot;orders-sort&quot;, &quot;valueNames&quot;: [&quot;date&quot;, &quot;total&quot;]}">
                                <table class="table align-middle fs-sm text-nowrap">
                                    ...
                                    <tbody class="text-body-emphasis orders-list" id="orders-list" data-value="${orderDTOs.size() == 0 ? 0 : 1}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-medium py-3 d-none d-md-table-cell">
                                                    <span class="d-flex align-items-center">
                                                        <span class="${item.donHang.tinhTrang == 'Hoàn thành' ? 'bg-success' : (item.donHang.tinhTrang == 'Đang giao hàng') ? 'bg-info' : (item.donHang.tinhTrang == 'Chưa giải quyết' ? 'bg-warning' : 'bg-danger')} rounded-circle p-1 me-2"></span>
                                                ...
                                                <td class="py-3 pe-0">
                                                    ...
                                                    <c:if test="${item.donHang.tinhTrang == 'Chưa giải quyết'}">
                                                        <form action="/Project-Finals/account-order" method="post" style="display: inline;">
                                                            <input type="hidden" name="orderId" value="${item.donHang.id}" />
    ...
    <script>
        ...
        %>
            ...
            alert(errorMessage);
            window.location.href = "/Project-Finals"; 
        <% } %>
        const orderList = document.getElementById("orders-list").getAttribute("data-value");
        if(orderList === "0"){
        ...
        function handleClick(orderId, status, chiTietListJson, totalPrice, deliveryAddress) {
            ...
            statusCircle.classList.remove("bg-info", "bg-success", "bg-danger");
