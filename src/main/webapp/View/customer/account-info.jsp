                                    ...
                                    <div class="modal fade" id="editBasicInfoModal" data-bs-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/update-info" method="post" class="row g-3 g-lg-4 needs-validation" novalidate>
                                                        <div class="col-lg-6">
                                    ...
                                    <div class="modal fade" id="editContactModal" data-bs-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/update-contact" method="post"  class="row g-3 g-lg-4 needs-validation" novalidate="">
                                                        <div class="col-lg-12">
                                                            <div class="position-relative">
                                    ...
                                    <div class="modal fade" id="editPasswordModal" data-bs-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/update-password" method="POST" class="row g-3 g-lg-4 needs-validation" novalidate="">
                                                        <div class="col-lg-6">
                                    ...
                                    <div class="modal fade" id="editAddressModal" data-bs-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/update-address" method="POST" class="row g-3 g-lg-4 needs-validation" novalidate="">
                                                        <div class="col-lg-12">
                                                            <div class="position-relative">
