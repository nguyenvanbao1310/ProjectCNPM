        ...
        <c:forEach var="item" items="${gh.getItems()}">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="w-100 min-w-0 ps-2 ps-sm-3">
                ...
                <div class="h6 pb-1 mb-2">${item.getDienThoai().getGia()}</div>
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <button
                    type="button" class="btn-close fs-sm" data-bs-toggle="modal" data-bs-target="#deleteModal_${item.getDienThoai().getId()}"
      ...
      <div class="offcanvas-header flex-column align-items-start">
        ...
        <div class="d-flex w-100 gap-3">
          <a class="btn btn-lg btn-secondary w-100"
             href="cart?action=viewCart&khachHangID=${sessionScope.idKH}" class="btn btn-primary"
            >View cart</a
          >
          <a
          ...
          >
            ...
            <div class="d-flex align-items-center">
              ...
              <a
                ...
                href="${pageContext.request.contextPath}/account-info"
              >
    ...
    <main class="content-wrapper">
      ...
      <section class="container pt-5 mt-2 mt-sm-3 mt-lg-4">
        ...
        <c:forEach var = "product" items ="${dt}">
            <form id = "productForm_${product.getId()}" action="detail" method="post">
                  ...
                  >
                    <div class="position-relative">
                      ...
                      <a
                        ...
                        href="javascript:void(0);" onclick="window.location.href='/Project-Finals/detail?id=${product.getId()}';"
                      >
                        <span
                    ...
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                        ...
                        <span class="text-body-tertiary fs-xs">(123)</span>
                          ...
                          <h3 class="pb-1 mb-2">
                            <a
                              ...
                              href="javascript:void(0);" onclick="document.getElementById('productForm_${product.getId()}').submit();"
                            >
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <button
                          ...
                          data-bs-target="#confirmAddToCartModal_${product.id}"
                      ...
                      <ul class="list-unstyled d-flex flex-column gap-2 m-0">
                        <li class="d-flex align-items-center">
                          ...
                          <span class="text-dark-emphasis fs-xs fw-medium text-end"
                            >${product.getManHinh()}</span
                          >
                        </li>
                        <li class="d-flex align-items-center">
                          <span class="fs-xs">Hệ điều hành:</span>
                          <span
                            class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                          ></span>
                          <span class="text-dark-emphasis fs-xs fw-medium text-end"
                            >${product.getHeDieuHanh()}</span
                          >
                        </li>
                        <li class="d-flex align-items-center">
                          <span class="fs-xs">Ram:</span>
                          <span
                            class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                          ></span>
                          <span class="text-dark-emphasis fs-xs fw-medium text-end"
                        ...
                        <li class="d-flex align-items-center">
                          <span class="fs-xs">Pin: </span>
                          <span
                            class="d-block flex-grow-1 border-bottom border-dashed px-1 mt-2 mx-2"
                          ></span>
                          <span class="text-dark-emphasis fs-xs fw-medium text-end"
                            >${product.getPin()} mAh</span
                          >
                        </li>
                      </ul>
                    </div>
        ...
        <c:forEach var = "product" items ="${dt}">
            <div class="modal fade" id="confirmAddToCartModal_${product.id}" tabindex="-1" aria-labelledby="confirmAddToCartModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <form id = "productForm1_${product.getId()}" action="" method="post">
                        <input type="hidden" name="action" value="addItem">
                        <input type="hidden" name="productId" value="${product.getId()}">
                        <input type="hidden" name="idGioHang" value="${gh.getIdGioHang()}">
                        <input type="hidden" name="idKhachHang" value="${gh.getKhachHang().getId()}">
                        <button type="button" class="btn btn-primary" onclick="document.getElementById('productForm1_${product.getId()}').submit();">
                            Đồng ý
                        </button>
                      </form>
            ...
            <div class="modal fade" id="deleteModal_${item.getDienThoai().getId()}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form id = "ItemForm_${item.getDienThoai().getId()}" action="" method="post">
