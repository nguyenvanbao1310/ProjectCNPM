    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!password.equals(retypePassword)) {
                ...
                // Tạo tài khoản trước
                TaiKhoan taiKhoan = new TaiKhoan(phone, password, EQuyen.KhachHang);
                TaiKhoanDAO.insert(taiKhoan);

                
                KhachHang khachHang = new KhachHang(taiKhoan, KhachHangDAO.CreateId(),name, dob, address, email, phone);
